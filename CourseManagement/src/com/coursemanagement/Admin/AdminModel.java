...
//====================ADDING TRAINERS=================================
	@Override
	public void addTrainer(String traineName, String dob, String experience, String phoneNo, String emailId,ArrayList subjects) {
		String dateArr[]=dob.split("/");
		LocalDate date = LocalDate.of(Integer.parseInt(dateArr[2]), Integer.parseInt(dateArr[1]),
				Integer.parseInt(dateArr[0]));
		String trainerId=Repository.getInstance().addTrainee(traineName,date,experience,phoneNo,emailId,subjects);
...
//=========================ADDING COURSES========================================
	...
	public boolean addCourses(String courseName, String courseInfo, ArrayList courseModules, LocalDate startDate,
		...
		return Repository.getInstance().addCourse(courseName,courseInfo,courseModules,startDate,endDate,examDate,traineeId);
