...
//========================Admin Index=============================================
	public void adminIndex(String userId) {
		...
		case 1:
			...
			adminModel.addAdmin(name, password, rePassword);
			break;
		case 2:
			...
			adminModel.addTrainer(traineName, dob, experience, phoneNo, emailId, subjects);
			break;
		case 3:
			adminModel.showTrainers();
			break;
		case 4:
			List<CourseInfo> courseInformation = adminModel.getCourseInfo();
		...
		case 5:
			...
			adminModel.viewTrainer();
			System.out.print("Enter Trainee ID to choose --->");
			String traineId = input.nextLine();
			adminModel.addCourse(courseName, courseInfo, courseModule, startDate, endDate, examDate, traineId);
		...
		case 6:
			...
			if (!courseId.substring(0, 3).equals("CID")) {
				...
				adminModel.deleteCourse(courseId);
			break;
		case 7:
